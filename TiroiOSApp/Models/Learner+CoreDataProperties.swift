...
extension Learner : Identifiable {
    ...
    @nonobjc public class func aFetchRequest() -> NSFetchRequest<Learner> {
...
extension Learner {
    static func create(name: String, created_by: User, profile_image_name : String?, image: Data?,  in context: NSManagedObjectContext) {
...
extension Learner {
    static func allLearnersFetchRequest() -> NSFetchRequest<Learner> {
        let request: NSFetchRequest<Learner> = Learner.fetchRequest() as! NSFetchRequest<Learner>

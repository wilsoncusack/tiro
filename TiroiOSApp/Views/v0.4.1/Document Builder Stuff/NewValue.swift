...
extension NewValue: Codable{
    ...
    private enum Base: String, Codable {
        case string, date, int, double, picker, pdf, images, document, quote, conversation
    }
    ...
    func encode(to encoder: Encoder) throws {
        ...
        case .double(let value):
            try container.encode(Base.double, forKey: .base)
        ...
        case .pdf(let value):
            try container.encode(Base.pdf, forKey: .base)
        ...
        case .quote(let value):
            try container.encode(Base.quote, forKey: .base)
            try container.encode(value, forKey: .quoteParams)
        case .conversation(let value):
            try container.encode(Base.conversation, forKey: .base)

...
class ImagePickerObject2: ObservableObject {
    ...
    init(tEl: TransientDocumentElement, images: [ImageWrapper]){
        ...
        self.listener = self.$images.sink { (arr) in
            ...
            tEl.value = Value.images(value: arr, displayType: DataArrayDisplayType.images, createType: DataArrayCreateDisplayType.photoLibrary, editType: DataArrayEditDisplayType.images)
        }
    }
